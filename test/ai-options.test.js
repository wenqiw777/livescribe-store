...
(async () => {
  ...
  const checks = [
    ['version is 0.1.1', manifest.version === '0.1.1'],
    ...
    ['Companion choice is present', /Use my ChatGPT \/ Claude subscription/.test(options)],
    ['Companion download is prominent', /id="downloadCompanion"/.test(options)],
