...
const checks = [
  ...
  ['API keys read from local storage', /storage\.local\.get\(\['apiKey', 'anthropicApiKey', 'openaiApiKey'\]/.test(background)],
  ['API keys saved to local storage', /storage\.local\.set\(\{[\s\S]*anthropicApiKey:[\s\S]*openaiApiKey:/.test(optionsJs)],
